package local.test.orderingsystem.controller;

import local.test.orderingsystem.entity.Account;
import local.test.orderingsystem.entity.Admin;
import local.test.orderingsystem.entity.User;
import local.test.orderingsystem.feign.AccountFeign;
import local.test.orderingsystem.utils.ReflectUtils;
